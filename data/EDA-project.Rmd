...
The above scatter and box plots show the distribution of the data after filtering out the years without enough attendance data. The number of observations in either variable is now closer to being equal, which is ideal for our next analysis steps.
...
# pretty_cor_table(data_combined$Year, data_combined$Enrollment, "Year", "Attendance")
```
