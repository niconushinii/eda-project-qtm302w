...
We are especially interested in examining data trends within the United States. Education policy and access here have evolved significantly over time, and exploring long-term patterns in enrollment and attendance can reveal how nation-wide policy changes or other events have impacted these measures. This directly relates to us, as college students who have undergone the three main levels of education and were told that our own efforts, most notably in high school, would determine our outcomes later in life. 

Attendance and enrollment jump out to us as variables of interest due to their potential interaction with one another. Also, as high school students during COVID we personally experienced a shift in both attendance and enrollment. This change took place throughout our schools and we seek to explore whether this shift occurred nation-wide.
